...
object Build extends Build {
  ...
  lazy val root = Project("hello-world", file("."), settings = gSettings ++ XitrumPackage.copy("configuration", "bin/runner.sh", "bin/runner.bat")).aggregate(uiConfigure, uiDevice, uiRbac)
