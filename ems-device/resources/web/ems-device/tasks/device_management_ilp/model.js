wdefine(function(){
    ...
    this.config("main_grid", {model: 'main_model',
        columns: [
            ...
            {"type":"string", "field":"mgt-connection.status","title":"Connection Status", valueMap: [
            ...
            {"type":"string", "field":"config-info.config-status","title":"Managed Status", valueMap: [
            ...
            {"type":"string", "field":"system.os-version","title":"OS Version","hidden":true},
            ...
            {"type":"string", "field":"config-info.candidate-config-state","title":"Configuration State","hidden":true, valueMap: [
                {value: "0", text: "NA"}, {value: "1", text: "Created"}, {value: "2", text: "Approved"}, {value: "3", text: "Rejected"}, {value: Nil, text: "NA"}
            ]},
            {"type":"string", "field":"system.last-reboot-time","title":"Last Rebooted Time","hidden":true, template: deviceRebootedTimeFormatter},
            {"type":"string", "field":"system.vendor","title":"Vendor","hidden":false},
            {"type":"string", "field":"mgt-connection.auth","title":"Authentication Status","hidden":false, valueMap: [
                {value: "0", text: "Credentials Based"}, {value: "1", text: "Key Based"}, {value: "2", text: "Key Conflict"}, {value: Nil, text: "NA"}
            ]},
            {"type":"string", "field":"mgt-connection.type","title":"Connection Type","hidden":true}
        ],
